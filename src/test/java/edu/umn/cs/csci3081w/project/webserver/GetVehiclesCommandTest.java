...
public class GetVehiclesCommandTest {
  ...
  public void testExexute() {
    ...
    GetVehiclesCommand getVehiclesCommand = new GetVehiclesCommand(visualTransitSimulator);
    JsonObject command = new JsonObject();
    getVehiclesCommand.execute(webServerSession, command);
  ...
  public void testExecuteReal() {
    ...
    try {
      ...
      GetVehiclesCommand getVehiclesCommand =
          new GetVehiclesCommand(visualTransitSimulator);
      JsonObject command = new JsonObject();
      getVehiclesCommand.execute(webServerSession, command);
      verify(webServerSession).sendJson(isA(JsonObject.class));
